        ...
        <div className="flex-1">
          ...
          <div className="mb-4 sm:mb-6">
              ...
              <div className="flex gap-2">
                ...
                <div className="relative flex-1" ref={sortDropdownRef}>
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-3 py-2.5 bg-white border-2 border-valentine-pink/30 rounded-xl text-valentine-red font-semibold shadow-md hover:border-valentine-red/50 hover:shadow-lg transition-all text-sm"
                  >
                  ...
                  {sortDropdownOpen && (
                    <div className="absolute left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border-2 border-valentine-pink/20 overflow-hidden z-50">
                      <div className="p-2 border-b border-gray-100">
                        <h3 className="font-bold text-valentine-red text-xs">Sort by</h3>
                      </div>
                      <div className="py-1">
                ...
                <div className="relative flex-1" ref={filtersRef}>
                  ...
                  {filtersOpen && (
                    <div className="absolute left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border-2 border-valentine-pink/20 overflow-visible z-50">
                      <div className="p-3 border-b border-gray-100 flex items-center justify-between">
                        <h3 className="font-bold text-valentine-red flex items-center gap-2 text-sm">
                          <Filter className="w-4 h-4" />
                          Filter by
                        </h3>
                        <button
                      ...
                      <div className="p-3 space-y-3">
                        ...
                        <div ref={categoryDropdownRef} className="relative">
                          <label className="block font-semibold text-xs text-gray-700 mb-1.5">Category</label>
                          <button
                            type="button"
                            onClick={() => setCategoryDropdownOpen(!categoryDropdownOpen)}
                            className="w-full flex items-center justify-between px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-left font-medium text-gray-800 hover:border-valentine-pink/40 transition-colors text-sm"
                          >
                            ...
                            <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform flex-shrink-0 ml-2 ${categoryDropdownOpen ? 'rotate-180' : ''}`} />
                          </button>
                          {categoryDropdownOpen && (
                            <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 max-h-48 overflow-y-auto">
                              <button
                                type="button"
                                onClick={() => {
                        ...
                        {/* Valentine Special */}
                        <div>
                          <label className="block font-semibold text-xs text-gray-700 mb-1.5">Type</label>
                          <label className="flex items-center gap-2 cursor-pointer p-2 rounded-lg hover:bg-valentine-pink/5">
                            ...
                            />
                            <span className="text-xs font-medium">💝 Valentine Special Only</span>
                          </label>
                        </div>
                      </div>
                    </div>
            ...
            <div className="hidden sm:flex flex-wrap items-center gap-3">
              <p className="text-sm sm:text-base text-gray-600 mr-auto">
