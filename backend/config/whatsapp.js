...
export const sendWhatsAppTemplate = async (to, templateName, languageCode = 'en', components = [], customerName = '') => {
  try {
    ...
    const response = await axios.post(
      ...
      {
        recipient_mobile_number: formattedTo,
...
/**
 * Send a plain text WhatsApp message via ChatMitra
 */
...
export default { sendWhatsAppMessage, sendWhatsAppTemplate, verifyWebhook };
